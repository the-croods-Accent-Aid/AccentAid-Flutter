...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (currentPage == DrawerSections.dashboard) {
      ...
      container = PersonalInformationPage();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          menuItem(2, "Learn", Icons.people_alt_outlined,
              currentPage == DrawerSections.Learn ? true : false),
          menuItem(3, "Progress", Icons.event,
              currentPage == DrawerSections.events ? true : false),
          menuItem(4, "Apply", Icons.notes,
              currentPage == DrawerSections.notes ? true : false),
          Divider(),
          menuItem(5, "Account", Icons.settings_outlined,
              currentPage == DrawerSections.settings ? true : false),
          menuItem(6, "Get In", Icons.notifications_outlined,
